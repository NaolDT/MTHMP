  ...
  return (
    <section className="relative overflow-hidden bg-brand-dark">
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 60% 80% at 50% 0%, rgba(37,99,235,0.35), transparent 70%)',
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 py-14 sm:py-20 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            to="/register"
            className="w-full sm:w-auto text-center rounded-lg bg-white text-brand-dark px-6 py-3 font-medium hover:bg-slate-100 hover:-translate-y-0.5 transition-all duration-200"
          >
