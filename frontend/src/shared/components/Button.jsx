export default function Button({ children, variant = 'primary', className = '', isLoading, disabled, ...props }) {
  const base = 'w-full sm:w-auto inline-flex items-center justify-center rounded-lg px-4 py-2.5 text-sm font-medium transition-colors disabled:opacity-60 disabled:cursor-not-allowed';
  const variants = {
